...
**YOU ARE IN: `yats/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/yats/` (rig root) or other directories
...
**Your mail address:** `yats/polecats/dementus`
**Your rig:** yats
**Your Witness:** `yats/witness`
...
| Ask Witness for help | `gt mail send yats/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`yats/witness`) when:
...
```bash
gt mail send yats/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
